...
public class HivePreProcess {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 */
		if (args.length != 2) {
			System.out.printf("Usage: HivePreProcess <input dir> <output dir> \n");
			System.exit(-1);
		}
		 ...
		 */
		job.setJarByClass(HivePreProcess.class);

		/*
		 * Specify an easily-decipherable name for the job. This job name will
		 * appear in reports and logs.
		 */
		job.setJobName("Hive Preprocess");
		 ...
		 */
		job.setMapperClass(HivedMapper.class);
